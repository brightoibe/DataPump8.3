...
public class NDRWriter {
    ...
    public void loadLabTestDictionary() {
        ...
        labTestDictionary.put(309, "2");
        labTestDictionary.put(1529, "3");
        labTestDictionary.put(1531, "8");
        labTestDictionary.put(308, "4");
        labTestDictionary.put(1528, "7");
        labTestDictionary.put(88, "11");
        labTestDictionary.put(1717, "12");
        labTestDictionary.put(1716, "13");
        labTestDictionary.put(366, "16");
        labTestDictionary.put(1175, "17");
        labTestDictionary.put(1159, "18");
        labTestDictionary.put(1167, "19");
        labTestDictionary.put(313, "21");
        labTestDictionary.put(451, "31");
        labTestDictionary.put(805, "32");
        labTestDictionary.put(228, "34");
        labTestDictionary.put(7777907, "35");
        labTestDictionary.put(391, "35");
        labTestDictionary.put(1157, "42");
        labTestDictionary.put(1158, "43");
        labTestDictionary.put(338, "53");
        labTestDictionary.put(1530, "54");
        labTestDictionary.put(368, "57");
        labTestDictionary.put(265, "58");
        labTestDictionary.put(1173, "59");
        labTestDictionary.put(365, "65");
        labTestDictionary.put(361, "71");
        labTestDictionary.put(1176, "74");
        labTestDictionary.put(315, "80");
        labTestDictionary.put(331, "81");
        labTestDictionary.put(391, "44");
        // labTestDictionary.put(451, "31");
    ...
    public void loadHIVEncounterDictionary() {
        ...
        /* EDD AND PMTCT LINK    */
        hivEncounterTypeDictionary.put(47, "P");
        ...
        hivEncounterTypeDictionary.put(1740, "NOFP");

        /*  FAMILY PLANNING METHOD */
        hivEncounterTypeDictionary.put(280, "FP1");
        hivEncounterTypeDictionary.put(311, "FP2");
        hivEncounterTypeDictionary.put(405, "FP3");
        hivEncounterTypeDictionary.put(408, "FP4");
        hivEncounterTypeDictionary.put(407, "FP5");
        hivEncounterTypeDictionary.put(7777863, "FP6");
        hivEncounterTypeDictionary.put(33, "FP7");
        ...
        /* WHO STAGING */
        hivEncounterTypeDictionary.put(7777925, "1");
        hivEncounterTypeDictionary.put(7777926, "2");
        hivEncounterTypeDictionary.put(7777927, "3");
        hivEncounterTypeDictionary.put(7777928, "4");

        /* TB STATUS */
        hivEncounterTypeDictionary.put(871, "1");
        hivEncounterTypeDictionary.put(870, "2");
        hivEncounterTypeDictionary.put(868, "3");
        hivEncounterTypeDictionary.put(872, "4");
        hivEncounterTypeDictionary.put(7777924, "5");

        /* OTHER OI PROBLEMS */
        hivEncounterTypeDictionary.put(1019, "1");
        hivEncounterTypeDictionary.put(439, "2");
        hivEncounterTypeDictionary.put(1046, "3");
        hivEncounterTypeDictionary.put(777838, "4");
        hivEncounterTypeDictionary.put(201, "5");
        hivEncounterTypeDictionary.put(194, "6");

        /* NOTED SIDE EFFECTS */
        hivEncounterTypeDictionary.put(706, "1");
        hivEncounterTypeDictionary.put(196, "2");
        hivEncounterTypeDictionary.put(1714, "3");
        hivEncounterTypeDictionary.put(573, "4");
        hivEncounterTypeDictionary.put(557, "5");
        hivEncounterTypeDictionary.put(181, "6");
        hivEncounterTypeDictionary.put(7777791, "7");
        hivEncounterTypeDictionary.put(671, "8");
        hivEncounterTypeDictionary.put(7777872, "9");
        hivEncounterTypeDictionary.put(1715, "10");
        hivEncounterTypeDictionary.put(7777787, "11");

        /* DRUG ADHERENCE */
        hivEncounterTypeDictionary.put(1398, "G");
        hivEncounterTypeDictionary.put(1485, "F");
        hivEncounterTypeDictionary.put(1397, "P");
    ...
    public void loadPatientDemographicDictionary() {
        ...
        patientDemographicDictionary.put(28, "1");
        patientDemographicDictionary.put(1525, "2");
        patientDemographicDictionary.put(518, "3");
        patientDemographicDictionary.put(1078, "4");
        patientDemographicDictionary.put(1523, "6");
        patientDemographicDictionary.put(1076, "EMP");
        patientDemographicDictionary.put(1521, "RET");
        patientDemographicDictionary.put(1520, "STU");
        patientDemographicDictionary.put(789, "NA");
        patientDemographicDictionary.put(350, "M");
        patientDemographicDictionary.put(346, "G");
        patientDemographicDictionary.put(348, "S");
        patientDemographicDictionary.put(351, "D");
        patientDemographicDictionary.put(349, "W");
        patientDemographicDictionary.put(347, "A");

    }

    public void loadHIVQuestionMapDictionary() {
        hivQueDictionary = new HashMap<Integer, String>();
        hivQueDictionary.put(1056, "1");
        hivQueDictionary.put(1066, "2");
        hivQueDictionary.put(243, "3");
        hivQueDictionary.put(7778234, "4");
        hivQueDictionary.put(1057, "5");
        hivQueDictionary.put(1055, "6");
        hivQueDictionary.put(7778236, "7");
        hivQueDictionary.put(7778233, "8");
        hivQueDictionary.put(1053, "9");
        hivQueDictionary.put(7777758, "10");
        hivQueDictionary.put(1058, "11");
        hivQueDictionary.put(7778237, "12");
        hivQueDictionary.put(1059, "13");
        hivQueDictionary.put(7778235, "14");
        hivQueDictionary.put(7778052, "HIVAb");
        hivQueDictionary.put(1661, "HIVPCR");
        hivQueDictionary.put(7777764, "T");
        hivQueDictionary.put(7777766, "NT");
        hivQueDictionary.put(7777765, "P");
        hivQueDictionary.put(7777767, "N");
        ...
        /*hivQueDictionary.put(884, "2");
        hivQueDictionary.put(243, "3");
        hivQueDictionary.put(1055, "6");
        hivQueDictionary.put(1053, "9");
        hivQueDictionary.put(45, "12");
        hivQueDictionary.put(1730, "1");
        hivQueDictionary.put(88, "2");
        hivQueDictionary.put(1153, "3");
        hivQueDictionary.put(1717, "4");
        hivQueDictionary.put(861, "1");
        hivQueDictionary.put(864, "2");
        hivQueDictionary.put(865, "3");
        hivQueDictionary.put(866, "4");
        hivQueDictionary.put(1009, "W");
        hivQueDictionary.put(1010, "A");
        hivQueDictionary.put(1012, "B");
        hivQueDictionary.put(971, "1");
        hivQueDictionary.put(870, "2");
        hivQueDictionary.put(868, "3");
        hivQueDictionary.put(872, "4");
        hivQueDictionary.put(869, "5");*/
    ...
    public void loadLocalCodingDictionary() {
        ...
        localCodeMapping.put("DAPSONE", "DDS");
    ...
    public HIVEncounterType createHIVEncounter(Visit visit, Date artStartDate, ArrayList<Obs> obsList, ArrayList<DrugOrder> orders, ArrayList<Drugs> drugList) throws DatatypeConfigurationException {
        ...
        int value_coded = 0;
        if (!obsList.isEmpty()) {
            String signsAndSymptoms = extractConceptCodes(528, obsList, hivEncounterTypeDictionary);
            if (StringUtils.isNoneEmpty(signsAndSymptoms)) {
                hivEncType.setOtherOIOtherProblems(signsAndSymptoms);
            }
            String notedSideEffects = extractConceptCodes(1607, obsList, hivEncounterTypeDictionary);
            ...
            Obs systolicObs = extractConcept(84, obsList);
            if (systolicObs != null) {
                systolic = systolicObs.getVariableValue();
            }
            Obs diastolicObs = extractConcept(568, obsList);
            ...
            for (Obs obs : obsList) {
                ...
                switch (conceptID) {
                    ...
                    case 1741:
                        value_coded = obs.getValueCoded();
                        hivEncType.setPatientFamilyPlanningCode(hivEncounterTypeDictionary.get(value_coded));
                        break;
                    case 1742:
                        value_coded = obs.getValueCoded();
